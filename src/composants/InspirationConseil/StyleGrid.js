...
const styles = [
  {
    nom: 'Bohème',
    image: `${process.env.PUBLIC_URL}/images/InspirationConseil/styles/boheme.jpg`,
    description:
  ...
  {
    nom: 'Scandinave',
    image: `${process.env.PUBLIC_URL}/images/InspirationConseil/styles/scandinave.jpg`,
    description:
  ...
  {
    nom: 'Minimaliste',
    image: `${process.env.PUBLIC_URL}/images/InspirationConseil/styles/minimaliste.jpg`,
    description:
  ...
  {
    nom: 'Moderne',
    image: `${process.env.PUBLIC_URL}/images/InspirationConseil/styles/moderne.jpg`,
    description:
  ...
  {
    nom: 'Classique',
    image: `${process.env.PUBLIC_URL}/images/InspirationConseil/styles/classique.jpg`,
    description:
  ...
  {
    nom: 'Art déco',
    image: `${process.env.PUBLIC_URL}/images/InspirationConseil/styles/artdeco.jpg`,
    description:
  ...
  {
    nom: 'Japandi',
    image: `${process.env.PUBLIC_URL}/images/InspirationConseil/styles/japandi.jpg`,
    description:
  ...
  {
    nom: 'Méditerranéen',
    image: `${process.env.PUBLIC_URL}/images/InspirationConseil/styles/mediterraneen.jpg`,
    description:
